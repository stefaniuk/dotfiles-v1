...
[core]
s0_active_plugins = core;composite;opengl;put;resize;imgpng;vpswitch;move;commands;copytex;wall;snap;grid;regex;mousepoll;compiztoolbox;place;unitymtgrabhandles;session;animation;fade;scale;workarounds;expo;ezoom;unityshell;
...
s0_put_next_output_key = <Control><Alt>n
